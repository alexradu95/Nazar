...
namespace Nazar.Framework.Stepperss;

public class AvatarSkeleton : IStepper
{
    private readonly LinePoint[] armLine = new LinePoint[4];
    private readonly LinePoint[] headLine = new LinePoint[3];
    ...
    public void Step()
    {
        ...
        for (int h = 0; h < 2; h++)
        {
            ...
            Plane flarePlane = new(flarePoint, Ray.FromTo(headLine[2].pt, handPos).Closest(flarePoint) - flarePoint);
